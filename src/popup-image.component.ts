  ...
  template: `
   <div class="ng-overlay" [hidden]="!openImageValid">
        <div class="ng-gallery-content" >    
                <a class="nav-left" *ngIf="listLenght > 1" (click)="prevImage()"><i class="fas fa-angle-left"></i></a>
                <img #imgpopup class="effect" alt="carregando..." />         
                <a class="nav-right" *ngIf="listLenght > 1" (click)="nextImage()"><i class="fas fa-angle-right"></i></a>
